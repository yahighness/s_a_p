# Generated by Django 3.2.8 on 2021-12-14 04:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='my_sap.profile')),
                ('tags', models.ManyToManyField(blank=True, to='my_sap.Tag')),
            ],
            options={
